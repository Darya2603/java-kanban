...
public abstract class TaskManagerTest<T extends TaskManager> {
    ...
    public void testCreateTask() {
        Task task = new Task(0, "Task #1", "Task1 description", Status.NEW, TaskType.TASK,
    ...
    public void testCreateSubtaskWithEpic() {
        Epic epic = new Epic(0, "Epic 1", "Epic description", Status.NEW,
    ...
    public void testTaskOverlap() {
        Task task1 = new Task(0, "Task #1", "Task1 description", Status.NEW,
                TaskType.TASK, Duration.ofMinutes(30), LocalDateTime.of(2023, 10, 1, 10, 0));
        manager.createTask(task1);

        Task task2 = new Task(0, "Task #2", "Task2 description", Status.NEW,
    ...
    public void testAddTask() {
        Task task = new Task(0, "Task 1", "Description 1", Status.NEW, TaskType.TASK,
    ...
    public void testRemoveAllTasks() {
        ...
        Task task1 = new Task(0, "Task 1", "Description 1", Status.NEW, TaskType.TASK,
                Duration.ofHours(1), now);
        Task task2 = new Task(0, "Task 2", "Description 2", Status.NEW, TaskType.TASK,
    ...
    public void testUpdateTask() {
        ...
        Task updatedTask = new Task(taskId, "Updated Task", "Updated Description",
                Status.IN_PROGRESS, TaskType.TASK, Duration.ofHours(2), LocalDateTime.now().plusHours(1));
    ...
    public void testAddSubtask() {
        ...
        Subtask subtask = new Subtask(0, "Subtask 1", "Subtask Description", Status.NEW,
    ...
    public void testRemoveAllSubtasks() {
        ...
        LocalDateTime now = LocalDateTime.now();
        Subtask subtask1 = new Subtask(0, "Subtask 1", "Subtask Description", Status.NEW,
                Duration.ofHours(1), now, epicId);
        Subtask subtask2 = new Subtask(0, "Subtask 2", "Subtask Description", Status.NEW,
    ...
    public void testUpdateSubtask() {
        ...
        Subtask updatedSubtask = new Subtask(subtaskId, "Updated Subtask", "Updated Description",
                Status.IN_PROGRESS, Duration.ofHours(2), LocalDateTime.now().plusHours(1), epicId);
