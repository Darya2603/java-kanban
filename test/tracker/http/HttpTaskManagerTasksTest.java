...
import tracker.manager.http.HttpTaskServer;
...
public class HttpTaskManagerTasksTest {
    private final TaskManager manager = new InMemoryTaskManagerImpl();
    ...
    public void testAddTask() throws IOException {
        Task task = new Task(1, "Task 1", "Testing task creation", Status.NEW,
    ...
    public void testUpdateTask() throws IOException, InterruptedException {
        Task task = new Task(1, "Test Task", "Testing task creation", Status.NEW,
    ...
    public void testDeleteTask() throws IOException, InterruptedException {
        Task task = new Task(1, "Test Task", "Testing task deletion", Status.NEW,
                TaskType.TASK, Duration.ofMinutes(5), LocalDateTime.now());
        manager.createTask(task);
    ...
    public void testAddSubtask() throws IOException {
        Epic epic = new Epic(0, "Epic Task", "Testing epic creation", Status.NEW,
        ...
        String jsonSubtask = gson.toJson(subtask);        URL url = new URL("http://localhost:8080/subtasks");
        HttpURLConnection connection = (HttpURLConnection) url.openConnection();
        connection.setRequestMethod("POST");
        connection.setDoOutput(true);
        connection.setRequestProperty("Content-Type", "application/json");
    ...
    public void testUpdateSubtask() throws IOException, InterruptedException {
        Epic epic = new Epic(1, "Epic Task", "Testing epic creation", Status.NEW,
                Duration.ofHours(1), LocalDateTime.now());
        manager.createEpic(epic);
    ...
    public void testUpdateEpic() throws IOException, InterruptedException {
        Epic epic = new Epic(1, "Epic Task", "Testing epic creation", Status.NEW,
                Duration.ofHours(1), LocalDateTime.now());
        manager.createEpic(epic);        epic.setNameTask("Updated Epic");
        ...
        assertEquals("Updated Epic", epicsFromManager.getFirst().getNameTask());
    }
